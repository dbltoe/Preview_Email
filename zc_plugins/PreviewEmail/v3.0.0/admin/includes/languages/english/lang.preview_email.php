...
$define = [
    ...
    'PREVIEW_EMAIL_BANNER_STYLESHEET' => 'Stylesheet:',
    'PREVIEW_EMAIL_BANNER_STYLESHEET_HOW' => '(poured into $EMAIL_COMMON_CSS in the template\'s <style> block)',
    'PREVIEW_EMAIL_BANNER_NO_STYLESHEET' => 'none found (core expects email/email_common.css and logs a warning without it)',
    'PREVIEW_EMAIL_BANNER_CSS_ALSO' => 'Also styled by:',
    'PREVIEW_EMAIL_BANNER_TEMPLATE_RULES' => 'rules the template carries in its own <style> block, beyond the stylesheet.',
    'PREVIEW_EMAIL_BANNER_INLINE_CSS' => 'inline style attributes, %1$d in the template file and %2$d in the message content the sending code supplies.',
    'PREVIEW_EMAIL_STATUS_STYLESHEET' => 'Stylesheet:',
